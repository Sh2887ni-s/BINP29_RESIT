...
Procedure:
    ...
    2. Calculate the distance matrics of GEO.csv and GEN.csv
    3. Predict the model of those two matrics.
    4.calculate the predict lat and lon, and find the closed population
...
#loop to store the country name in the list and the data in the matrics
while i < len(GEO):
    line=GEO[i]
    line1=line.replace('\n', '')
    line1=line1.split(',')
...
#loop to store the group name and sample ID in the list and the data in the matrics
while j < len(data):
    line=data[j]
    line1=line.replace('\n', '')
    line1=line1.split(',')
